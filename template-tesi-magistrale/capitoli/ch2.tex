...
\begin{figure}[t]
    ...
    \caption{Ciclo di interazione Agente-Ambiente. \\
    Immagine tratta da \cite{Sutton2018}}
    \label{fig:agente_ambiente}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{dyna-q.png}
    \caption{Schema logico dell'algoritmo Dyna-Q. \\
    Immagine tratta da \cite{Sutton2018}}
\end{figure}
...
DQN introduce una seconda rete, la \textit{Target Network} ($\theta^-$), che viene mantenuta fissa e aggiornata periodicamente (o tramite media mobile esponenziale). La loss function diventa:
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{dqn.png}
    \caption{Schema architetturale dell'algoritmo DQN. \\
    Immagine tratta da \cite{Mnih2015}}
    \label{fig:dqn_rl}
\end{figure}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.8\textwidth]{dueling_dqn.png}
    \caption{Schema logico della Dueling DQN. \\
    Immagine tratta da \cite{Wang2016}}
...
\begin{figure}[H]
    ...
    \caption{Funzione obiettivo di PPO: il meccanismo di clipping impedisce aggiornamenti troppo aggressivi della policy quando il rapporto di probabilità $r_t$ diverge \cite{Schulman2017}.}
